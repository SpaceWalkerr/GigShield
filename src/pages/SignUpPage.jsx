...
function SignUpPage({ setSession }) {
    ...
    return (
      ...
      >
        <div className="w-full max-w-md mx-auto text-center space-y-6">
          ...
          <Link
            to="/signin"
            className="block w-full rounded-2xl bg-white px-5 py-4 text-sm font-black text-zinc-950 transition hover:bg-zinc-200"
          >
            Sign In
          </Link>
        </div>
  ...
  return (
    <AuthPageShell
      ...
      title={selectLabel(
        languageMode,
        "Join GigShield. Ride protected.",
        "GigShield से जुड़ें। सुरक्षित राइड करें।",
      )}
      description={selectLabel(
        languageMode,
        "Create your account in under 2 minutes and start receiving automatic payouts for weather and platform disruptions.",
        "2 मिनट में अकाउंट बनाएं और मौसम व प्लेटफ़ॉर्म बाधाओं के लिए अपने आप भुगतान पाना शुरू करें।",
      )}
      asideItems={[
        {
          title: selectLabel(
            languageMode,
            "Rain, heatwave, and outage payouts",
            "बारिश, गर्मी और आउटेज भुगतान",
          ),
        ...
        },
        {
          title: selectLabel(
            languageMode,
            "Zero paperwork, instant activation",
            "शून्य कागजी कार्रवाई, त्वरित सक्रियण",
          ),
        ...
        },
        {
          title: selectLabel(
            languageMode,
            "Works across Zomato, Swiggy, Blinkit",
            "ज़ोमैटो, स्विगी, ब्लिंकिट पर काम करता है",
          ),
        ...
        <div className="space-y-6">
          <AuthPanel className="space-y-4">
            ...
            <button
              ...
              onClick={async () => {
                ...
                setAuthError(null);
                try {
                  const sessionData = await signUpWithEmail({
                    email,
                    password,
                    fullName,
                  });
                  ...
                  if (msg.includes("422")) {
                    setAuthError(
                      "Sign-up failed. Password might be too weak or the email is already in use.",
                    );
                  } else {
                    setAuthError(msg);
                  }
          ...
          <AuthPanel>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-sm font-bold text-white">
                  ...
                  {selectLabel(languageMode, "week", "हफ्ता")}
                </p>
            ...
            <p className="text-xs text-zinc-400 leading-relaxed italic">
              {selectLabel(
                languageMode,
                "* Additional details like city and worker ID will be verified during the activation process.",
                "* शहर और वर्कर आईडी जैसे अतिरिक्त विवरण सक्रियण प्रक्रिया के दौरान सत्यापित किए जाएंगे।",
              )}
            </p>
          </AuthPanel>
        </div>
